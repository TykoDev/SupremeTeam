...
4. Execute the targeted suites, capture the runner's own output to a file under the phase `evidence/` directory, and record exactly what passed, failed, or stayed out of scope, including the command needed to reproduce the result.
