...
| Redesign parity | Map before you change: a stable-id inventory of the current design is the parity contract, and four differentiated living variants are compared on evidence before one is built. | [redesign](../design/redesign/SKILL.md) and [design-mapper](../design/design-mapper/SKILL.md) |
