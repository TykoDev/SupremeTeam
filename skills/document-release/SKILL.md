...
5. **Hold publication for a named owner's approval**: the draft is the deliverable, and publication is someone else's decision. Approval names the owner, the exact draft revision, and the channels approved; an approval of an earlier draft does not carry to a changed one. Absent that approval, return the draft and name the missing approver.
