...
`--prior review/verdict_review-to-delivery.json` and writes its own record beside it as
`verdict_review-to-delivery.cross-stage.json`. When persistence is inactive, return the
